...
describe("official visa evidence", () => {
  ...
  it("covers the reviewed Bahrain, Qatar, Saudi Arabia, and Jordan pass", () => {
    ...
    expect(pairsFor("SA")).toHaveLength(87);
    ...
    expect(getVisaRelationshipEvidence("BD", "SA", "evisa").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("BR", "SA", snapshot.passports.BR.statuses.SA).supportsCurrentStatus).toBe(false);

    expect(pairsFor("JO")).toHaveLength(55);
  ...
  it("keeps Iran and Iraq evidence conservative when official nationality scope is incomplete", () => {
    ...
    expect(pairsFor("IR")).toHaveLength(41);
    ...
    expect(pairsFor("IQ")).toHaveLength(17);
  ...
  it("supports named Turkish access to Palestine and Syria while applying Yemen's advance-visa grid", () => {
    ...
    expect(pairsFor("PS")).toHaveLength(6);
    ...
    expect(pairsFor("SY")).toHaveLength(7);
    ...
    expect(getVisaRelationshipEvidence("GB", "SY", snapshot.passports.GB.statuses.SY).supportsCurrentStatus).toBe(false);
  ...
  it("covers the reviewed Mongolia and Uzbekistan routes", () => {
    ...
    expect(uzbekistanPairs).toHaveLength(197);
  ...
  it("covers the reviewed Bhutan, Bangladesh, and Pakistan routes", () => {
    ...
    expect(pairsFor("BD")).toHaveLength(31);
  ...
  it("covers Tajikistan and named Turkmenistan rows while preserving source gaps", () => {
    ...
    expect(pairsFor("TM")).toHaveLength(14);
    ...
    expect(pairsFor("AF")).toHaveLength(3);
  ...
  it("covers Timor-Leste while preserving North Korea's unpublished nationality scope", () => {
    ...
    expect(pairsFor("KP")).toHaveLength(2);
  ...
  it("covers the reviewed Ghana and Tanzania schedules", () => {
    ...
    expect(pairsFor("TZ")).toHaveLength(195);
  ...
  it("covers the reviewed Algeria, Nigeria, and Senegal schedules", () => {
    ...
    expect(pairsFor("NG")).toHaveLength(56);
  ...
  it("covers Cameroon, Côte d'Ivoire, and named Tunisia outbound rows", () => {
    ...
    expect(pairsFor("CI")).toHaveLength(43);
    ...
    expect(pairsFor("TN")).toHaveLength(24);
  ...
  it("covers Eritrea and Gambia with named outbound Libya evidence", () => {
    ...
    expect(pairsFor("LY")).toHaveLength(9);
    expect(getVisaRelationshipEvidence("US", "LY", "visa_required").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("CA", "LY", "visa_required").supportsCurrentStatus).toBe(true);
  ...
  it("keeps Sudan conservative and supports only South Sudan's named exemptions", () => {
    ...
    expect(pairsFor("SD")).toHaveLength(6);
    ...
    expect(pairsFor("SS")).toHaveLength(13);
    ...
    expect(getVisaRelationshipEvidence("GB", "SS", snapshot.passports.GB.statuses.SS).supportsCurrentStatus).toBe(false);
  ...
  it("covers the reviewed Burkina Faso, Guinea-Bissau, Sierra Leone, and Burundi scopes", () => {
    ...
    expect(pairsFor("BF")).toHaveLength(54);
  ...
  it("supports the CEMAC cohorts and named outbound rows for Congo and Gabon", () => {
    ...
    expect(pairsFor("CG")).toHaveLength(12);
  ...
  it("supports CEMAC and named outbound rows for the Central African Republic and Equatorial Guinea", () => {
    ...
    expect(pairsFor("CF")).toHaveLength(11);
    ...
    expect(pairsFor("GQ")).toHaveLength(40);
  ...
  it("keeps British Virgin Islands evidence to directly reviewed outbound exemptions", () => {
    const pairs = evidenceRelationshipPairs(snapshot.manifest)
  ...
  it("keeps Serbia, Türkiye, and Russia aligned to independently reviewed current schedules", () => {
    ...
    expect(pairsFor("TR")).toHaveLength(161);
  ...
  it("keeps Moldova, Montenegro, and the supported North Macedonia cohort aligned to reviewed official sources", () => {
    ...
    expect(pairsFor("MK")).toHaveLength(33);
  ...
  it("keeps the reviewed Bosnia, Kosovo, and Andorra relationships aligned to current official rules", () => {
    ...
    expect(pairsFor("BA")).toHaveLength(38);
    ...
    expect(pairsFor("XK")).toHaveLength(26);
  ...
  it("supports named outbound rows for Ukraine, Djibouti, and Comoros", () => {
    ...
    expect(pairsFor("UA")).toHaveLength(25);
    ...
    expect(pairsFor("KM")).toHaveLength(16);
  ...
  it("supports the reviewed Cuba, Haiti and Saint Kitts and Nevis scopes", () => {
    ...
    expect(pairsFor("CU")).toHaveLength(40);
    ...
    expect(getVisaRelationshipEvidence("IE", "CU", "visa_free").supportsCurrentStatus).toBe(true);
  ...
  it("supports reviewed Portuguese, Swedish, and Finnish outbound rows", () => {
    ...
    expect(getVisaRelationshipEvidence("FI", "BA", snapshot.passports.FI.statuses.BA).supportsCurrentStatus).toBe(false);
  });

  it("supports reviewed Belgian, Danish, and Norwegian outbound rows", () => {
    expect(getVisaRelationshipEvidence("BE", "LY", "visa_required").supportsCurrentStatus).toBe(true);
  ...
  it("supports reviewed Palestinian, Libyan, and Yemeni outbound rows", () => {
    ...
    expect(getVisaRelationshipEvidence("PS", "CU", snapshot.passports.PS.statuses.CU).supportsCurrentStatus).toBe(false);
  ...
  it("supports reviewed Afghan, Macao, and Burundian outbound rows", () => {
    ...
    expect(getVisaRelationshipEvidence("AF", "VG", snapshot.passports.AF.statuses.VG).supportsCurrentStatus).toBe(false);
  ...
  it("supports reviewed Moldovan, Montenegrin, and Zambian outbound rows", () => {
    ...
    expect(getVisaRelationshipEvidence("MD", "XK", snapshot.passports.MD.statuses.XK).supportsCurrentStatus).toBe(false);
  ...
  it("supports reviewed Eritrean, Timorese, and DRC outbound rows", () => {
    ...
    expect(getVisaRelationshipEvidence("TL", "KH", snapshot.passports.TL.statuses.KH).supportsCurrentStatus).toBe(false);
  ...
  it("supports reviewed Rwandan and Mozambican rows without flattening held routes", () => {
    for (const destinationCode of ["BD", "CF", "CG", "CI", "GW", "LR", "ML", "NE"] as const) {
    ...
    expect(getVisaRelationshipEvidence("RW", "KH", snapshot.passports.RW.statuses.KH).supportsCurrentStatus).toBe(false);
    ...
    expect(getVisaRelationshipEvidence("SD", "CU", snapshot.passports.SD.statuses.CU).supportsCurrentStatus).toBe(false);
  ...
  it("supports reviewed Albanian, North Macedonian, and Serbian outbound rows", () => {
    ...
    expect(getVisaRelationshipEvidence("MK", "KH", snapshot.passports.MK.statuses.KH).supportsCurrentStatus).toBe(false);
    expect(getVisaRelationshipEvidence("MK", "UA", snapshot.passports.MK.statuses.UA).supportsCurrentStatus).toBe(false);
  ...
  it("supports reviewed Tongan, Haitian, and Myanmar outbound rows", () => {
    ...
    expect(getVisaRelationshipEvidence("TO", "KH", snapshot.passports.TO.statuses.KH).supportsCurrentStatus).toBe(false);
    expect(getVisaRelationshipEvidence("HT", "CU", snapshot.passports.HT.statuses.CU).supportsCurrentStatus).toBe(false);
  });
  ...
  it("supports reviewed Armenian, Bosnian, and HKSAR outbound rows", () => {
    for (const passportCode of ["AM", "BA", "HK"] as const) {
      ...
      expect(getVisaRelationshipEvidence(passportCode, "GQ", "evisa").supportsCurrentStatus).toBe(true);
      expect(getVisaRelationshipEvidence(passportCode, "CI", snapshot.passports[passportCode].statuses.CI).supportsCurrentStatus).toBe(false);
      expect(getVisaRelationshipEvidence(passportCode, "CU", snapshot.passports[passportCode].statuses.CU).supportsCurrentStatus).toBe(false);
    }
  ...
  it("supports reviewed Burkinabè, Israeli, and Sri Lankan outbound rows", () => {
    ...
    expect(getVisaRelationshipEvidence("BF", "CU", snapshot.passports.BF.statuses.CU).supportsCurrentStatus).toBe(false);
  ...
  it("supports reviewed Antiguan, Dominican, and Bhutanese outbound rows", () => {
    ...
    expect(getVisaRelationshipEvidence("BT", "KH", snapshot.passports.BT.statuses.KH).supportsCurrentStatus).toBe(false);
    expect(getVisaRelationshipEvidence("BT", "UA", snapshot.passports.BT.statuses.UA).supportsCurrentStatus).toBe(false);
  });
  ...
  it("supports reviewed Andorran, Argentine, and Azerbaijani outbound rows", () => {
    ...
    expect(getVisaRelationshipEvidence("AR", "PA", snapshot.passports.AR.statuses.PA).supportsCurrentStatus).toBe(false);
  });
  ...
  it("supports reviewed Belarusian, Belizean, and Brazilian outbound rows", () => {
    for (const passportCode of ["BY", "BZ", "BR"] as const) {
      ...
      expect(getVisaRelationshipEvidence(passportCode, "CU", snapshot.passports[passportCode].statuses.CU).supportsCurrentStatus).toBe(false);
      expect(getVisaRelationshipEvidence(passportCode, "CI", snapshot.passports[passportCode].statuses.CI).supportsCurrentStatus).toBe(false);
      expect(getVisaRelationshipEvidence(passportCode, "KH", snapshot.passports[passportCode].statuses.KH).supportsCurrentStatus).toBe(false);
      expect(getVisaRelationshipEvidence(passportCode, "UA", snapshot.passports[passportCode].statuses.UA).supportsCurrentStatus).toBe(false);
    }
  });
  ...
  it("supports the reviewed French, Swiss, and Dutch outbound rows", () => {
    ...
    expect(getVisaRelationshipEvidence("NL", "BD", "visa_required").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("NL", "DJ", snapshot.passports.NL.statuses.DJ).supportsCurrentStatus).toBe(false);
    expect(getVisaRelationshipEvidence("NL", "GQ", snapshot.passports.NL.statuses.GQ).supportsCurrentStatus).toBe(false);
  });
