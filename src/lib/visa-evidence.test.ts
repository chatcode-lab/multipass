...
describe("visa relationship URLs", () => {
  ...
  it("resolves reviewed unknown relationship URLs without treating them as verified", () => {
    ...
    expect(getVisaRelationshipEvidence("FJ", "XK", "unknown").reviewedUnknown)
      .toMatchObject({ rejectedStatus: "visa_free" });
    expect(getVisaRelationshipEvidence("DO", "MD", "unknown").reviewedUnknown)
      .toMatchObject({ rejectedStatus: "evisa" });
...
describe("official visa evidence", () => {
  ...
  it("supports the seeded policy examples without claiming unsupported pairs", () => {
    ...
    expect(getVisaRelationshipEvidence("BE", "TD", "evisa").supportsCurrentStatus).toBe(true);
  ...
  it("expands Hong Kong's reviewed ordinary-passport schedule without flattening special arrangements", () => {
    ...
    expect(hongKongPairs).toHaveLength(196);
  ...
  it("covers South Africa's complete foreign ordinary-passport scope", () => {
    ...
    expect(southAfricaPairs).toHaveLength(199);
  ...
  it("covers The Bahamas' complete current ordinary-passport scope", () => {
    ...
    expect(getVisaRelationshipEvidence("SS", "BS", "visa_free").supportsCurrentStatus).toBe(true);
  ...
  it("covers Mauritius while leaving obsolete or absent country rows unresolved", () => {
    ...
    expect(mauritiusPairs).toHaveLength(199);
  ...
  it("classifies Rwanda's universal arrival visa without treating fee waivers as visa-free", () => {
    ...
    expect(rwandaPairs).toHaveLength(199);
    ...
    expect(getVisaRelationshipEvidence("RW", "RW", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("supports Saint Vincent and the Grenadines' named pre-entry and residual visa-free cohorts", () => {
    ...
    expect(getVisaRelationshipEvidence("VC", "VC", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("covers the reviewed Madagascar, Palau, Vanuatu, Cabo Verde, and Mozambique pass", () => {
    ...
    expect(getVisaRelationshipEvidence("MZ", "MZ", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("covers the reviewed Uganda, Benin, Antigua and Barbuda, and Colombia pass", () => {
    ...
    expect(getVisaRelationshipEvidence("UG", "UG", "citizenship").supportsCurrentStatus).toBe(true);
  ...
  it("keeps route-split Palestinian access unresolved while applying the supported Syria and Yemen rules", () => {
    ...
    for (const passportCode of ["CA", "IE", "DE", "FR", "NL", "ES", "BE", "IT"] as const) {
      expect(
        getVisaRelationshipEvidence(
          passportCode,
          "PS",
    ...
    expect(snapshot.passports.TR.statuses.PS).toBe("visa_required");
    expect(getVisaRelationshipEvidence("TR", "PS", "visa_required").supportsCurrentStatus).toBe(false);
  ...
  it("covers the reviewed Mongolia and Uzbekistan routes", () => {
    ...
    expect(mongoliaPairs).toHaveLength(198);
    ...
    expect(getVisaRelationshipEvidence("CU", "MN", "visa_required").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("GE", "MN", "visa_required").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("XK", "MN", snapshot.passports.XK.statuses.MN).supportsCurrentStatus).toBe(false);
    expect(getVisaRelationshipEvidence("MN", "MN", "citizenship").supportsCurrentStatus).toBe(true);
  ...
  it("covers the reviewed Macao, Brunei, and Kyrgyzstan routes", () => {
    ...
    expect(pairsFor("MO")).toHaveLength(197);
    ...
    expect(getVisaRelationshipEvidence("MO", "MO", "citizenship").supportsCurrentStatus).toBe(true);

    expect(pairsFor("BN")).toHaveLength(199);
  ...
  it("covers mainland China's reviewed ordinary-passport baseline", () => {
    ...
    expect(chinaPairs).toHaveLength(196);
    ...
    expect(getVisaRelationshipEvidence("CN", "CN", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("covers the reviewed Bhutan, Bangladesh, and Pakistan routes", () => {
    ...
    expect(pairsFor("PK")).toHaveLength(193);
    ...
    expect(getVisaRelationshipEvidence("PK", "PK", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("covers Tajikistan and named Turkmenistan rows while preserving source gaps", () => {
    ...
    expect(pairsFor("AF")).toHaveLength(12);
    ...
    expect(getVisaRelationshipEvidence("AF", "AF", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("covers Timor-Leste while keeping North Korea's unsupported nationality scope bounded", () => {
    ...
    expect(pairsFor("KP")).toHaveLength(13);
    ...
    expect(getVisaRelationshipEvidence("DK", "KP", "visa_required").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("AT", "KP", "visa_required").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("SE", "KP", "visa_required").supportsCurrentStatus).toBe(false);
    expect(getVisaRelationshipEvidence("US", "KP", "entry_restricted").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("US", "KP", snapshot.passports.US.statuses.KP).supportsCurrentStatus).toBe(true);
  ...
  it("covers the reviewed Algeria, Nigeria, and Senegal schedules", () => {
    ...
    expect(pairsFor("NG")).toHaveLength(196);
    ...
    expect(getVisaRelationshipEvidence("NG", "NG", "citizenship").supportsCurrentStatus).toBe(true);

    expect(pairsFor("SN")).toHaveLength(199);
    ...
    expect(getVisaRelationshipEvidence("SN", "SN", "citizenship").supportsCurrentStatus).toBe(true);

    expect(pairsFor("MA")).toHaveLength(195);
    ...
    expect(getVisaRelationshipEvidence("MA", "MA", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("covers Cameroon, Côte d'Ivoire, and named Tunisia outbound rows", () => {
    ...
    expect(pairsFor("CM")).toHaveLength(199);
    ...
    expect(getVisaRelationshipEvidence("CI", "CI", "citizenship").supportsCurrentStatus).toBe(true);

    expect(pairsFor("TN")).toHaveLength(46);
    ...
    expect(getVisaRelationshipEvidence("TN", "TN", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("covers the reviewed Egypt and Mauritania visitor schedules", () => {
    ...
    expect(pairsFor("EG")).toHaveLength(193);
    ...
    expect(getVisaRelationshipEvidence("EG", "EG", "citizenship").supportsCurrentStatus).toBe(true);

    expect(pairsFor("MR")).toHaveLength(199);
    ...
    expect(getVisaRelationshipEvidence("MR", "MR", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("covers Eritrea and Gambia with named outbound Libya evidence", () => {
    ...
    expect(pairsFor("ER")).toHaveLength(199);
    ...
    expect(getVisaRelationshipEvidence("ER", "ER", "citizenship").supportsCurrentStatus).toBe(true);
  ...
  it("keeps Sudan conservative and supports scoped South Sudan routes", () => {
    ...
    expect(pairsFor("SD")).toHaveLength(25);
    ...
    expect(getVisaRelationshipEvidence("CA", "SD", "visa_required").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("AU", "SD", "visa_required").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("MY", "SD", snapshot.passports.MY.statuses.SD).supportsCurrentStatus).toBe(false);

    expect(pairsFor("SS")).toHaveLength(31);
    ...
    expect(getVisaRelationshipEvidence("SS", "SS", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("covers the reviewed Burkina Faso, Guinea-Bissau, Sierra Leone, and Burundi scopes", () => {
    ...
    expect(pairsFor("BF")).toHaveLength(71);
    ...
    expect(pairsFor("GW")).toHaveLength(39);
    ...
    expect(pairsFor("SL")).toHaveLength(199);
    ...
    expect(pairsFor("BI")).toHaveLength(199);
    ...
    expect(getVisaRelationshipEvidence("BI", "BI", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("supports the CEMAC cohorts and named outbound rows for Congo and Gabon", () => {
    ...
    expect(pairsFor("GA")).toHaveLength(199);
    ...
    expect(getVisaRelationshipEvidence("GA", "GA", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("supports CEMAC and named outbound rows for the Central African Republic and Equatorial Guinea", () => {
    ...
    expect(pairsFor("CF")).toHaveLength(24);
    ...
    expect(getVisaRelationshipEvidence("CF", "CF", "citizenship").supportsCurrentStatus).toBe(true);
  ...
  it("covers the reviewed Lesotho and Eswatini schedules conservatively", () => {
    ...
    expect(pairsFor("LS")).toHaveLength(199);
    ...
    expect(getVisaRelationshipEvidence("LS", "LS", "citizenship").supportsCurrentStatus).toBe(true);

    expect(pairsFor("SZ")).toHaveLength(197);
  ...
  it("models Guinea's approval-letter route as ETA rather than eVisa or VOA", () => {
    ...
    expect(getVisaRelationshipEvidence("GN", "GN", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("keeps Mali, Niger, and Liberia to directly supported current cohorts", () => {
    ...
    expect(maliPairs).toHaveLength(42);
    expect(nigerPairs).toHaveLength(41);
    ...
    expect(getVisaRelationshipEvidence("ML", "ML", "citizenship").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("NE", "NE", "citizenship").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("LR", "LR", "citizenship").supportsCurrentStatus).toBe(true);
  });

  it("keeps Chad's named exemption list while applying reviewed eVisa transitions", () => {
    const pairs = evidenceRelationshipPairs(snapshot.manifest)
    ...
    expect(getVisaRelationshipEvidence("PS", "TD", "visa_required").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("PS", "TD", "evisa").supportsCurrentStatus).toBe(false);
  ...
  it("keeps reviewed current U.S. entry restrictions explicit", () => {
    for (const passportCode of [
      "PS", "AF", "SS", "DM", "TO", "LY", "SO", "SY", "BI", "CG", "HT", "IR", "SD", "AO", "AG", "VE", "ZM", "ZW",
      "CI", "BF", "SL", "GA", "NG", "SN", "ER", "GQ", "LA", "MW", "MM", "CU", "TZ",
    ] as const) {
      expect(snapshot.passports[passportCode].statuses.US).toBe("entry_restricted");
      expect(getVisaRelationshipEvidence(passportCode, "US", "entry_restricted").supportsCurrentStatus).toBe(true);
    }
  });
  ...
  it("maps Angola's Decree 189/23 exemption and preauthorised border-visa routes", () => {
    ...
    expect(getVisaRelationshipEvidence("AO", "AO", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("covers Dominica's named and conditional short-stay exemptions", () => {
    ...
    expect(getVisaRelationshipEvidence("DM", "DM", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("keeps French overseas destinations outside Schengen with territory-specific scope", () => {
    for (const destinationCode of ["GF", "YT", "RE"] as const) {
      const pairs = evidenceRelationshipPairs(snapshot.manifest)
        .filter(({ destination }) => destination.code === destinationCode);
      expect(pairs, destinationCode).toHaveLength(197);
      ...
      for (const passportCode of ["AL", "ME", "MK"] as const) {
        expect(getVisaRelationshipEvidence(passportCode, destinationCode, "visa_free").supportsCurrentStatus).toBe(true);
      }
      for (const passportCode of ["RS", "UA"] as const) {
        expect(getVisaRelationshipEvidence(passportCode, destinationCode, snapshot.passports[passportCode].statuses[destinationCode]).supportsCurrentStatus).toBe(false);
      }
    }
    ...
    expect(frenchWestIndiesPairs).toHaveLength(195);
  ...
  it("keeps Dominican Republic conflicts unresolved while covering direct cohorts", () => {
    ...
    expect(getVisaRelationshipEvidence("DO", "DO", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("maps Belize's current ordinary-passport visa table without filling ambiguous rows", () => {
    ...
    expect(getVisaRelationshipEvidence("BZ", "BZ", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("maps Costa Rica's 2025 ordinary-passport directive and restricted residual", () => {
    ...
    expect(getVisaRelationshipEvidence("CR", "CR", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("maps Honduras' current CA-4 schedule without filling absent issuers or the home cell", () => {
    ...
    expect(getVisaRelationshipEvidence("IN", "HN", "visa_free").supportsCurrentStatus).toBe(true);
    for (const passportCode of ["AL", "HK", "MO", "XK"] as const) {
      expect(getVisaRelationshipEvidence(
        passportCode,
        "HN",
  ...
  it("maps El Salvador's full current A, B and C nationality schedule", () => {
    ...
    expect(getVisaRelationshipEvidence("SV", "SV", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("covers Venezuela's named air-entry waivers and electronic tourist visas", () => {
    ...
    expect(getVisaRelationshipEvidence("VE", "VE", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("covers Papua New Guinea's named arrival, electronic, and advance-visa cohorts", () => {
    ...
    expect(getVisaRelationshipEvidence("PG", "PG", "citizenship").supportsCurrentStatus).toBe(true);
  });
  ...
  it("keeps Moldova, Montenegro, and the supported North Macedonia cohort aligned to reviewed official sources", () => {
    ...
    expect(pairsFor("ME")).toHaveLength(199);
    ...
    expect(getVisaRelationshipEvidence("ME", "ME", "citizenship").supportsCurrentStatus).toBe(true);
    ...
    expect(pairsFor("MK")).toHaveLength(198);
    ...
    expect(getVisaRelationshipEvidence("HK", "MK", snapshot.passports.HK.statuses.MK).supportsCurrentStatus).toBe(false);
  });
  ...
  it("keeps the reviewed Bosnia, Kosovo, and Andorra relationships aligned to current official rules", () => {
    ...
    expect(pairsFor("BA")).toHaveLength(199);
    ...
    expect(getVisaRelationshipEvidence("SS", "BA", "visa_required").supportsCurrentStatus).toBe(true);
  ...
  it("keeps the reviewed Monaco, San Marino, and Belarus relationships aligned to current official rules", () => {
    ...
    expect(pairsFor("MC")).toHaveLength(199);
    ...
    expect(getVisaRelationshipEvidence("MC", "MC", "citizenship").supportsCurrentStatus).toBe(true);
  ...
  it("supports the reviewed Cuba, Haiti and Saint Kitts and Nevis scopes", () => {
    ...
    expect(currentCubaPairs).toHaveLength(199);
  ...
  it("supports the shared French West Indies territorial schedule without flattening document exceptions", () => {
    ...
    for (const passportCode of ["EC", "RS", "UA", "VU"] as const) {
  ...
  it("covers reviewed Argentine, Chilean, Russian, and Kuwaiti residuals conservatively", () => {
    ...
    expect(getVisaRelationshipEvidence("CL", "MK", snapshot.passports.CL.statuses.MK).supportsCurrentStatus).toBe(true);
    ...
    for (const destinationCode of ["AF", "AO", "CF", "CG", "GD", "LR", "ML", "NE", "KP", "MK", "TT", "TM"] as const) {
      expect(getVisaRelationshipEvidence("KW", destinationCode, "visa_required").supportsCurrentStatus).toBe(true);
    }
    expect(snapshot.passports.KW.statuses.TD).toBe("evisa");
    expect(getVisaRelationshipEvidence("KW", "TD", "evisa").supportsCurrentStatus).toBe(true);
  ...
  it("covers reviewed Albanian, Somali and Syrian residuals while preserving conditional holds", () => {
    ...
    expect(getVisaRelationshipEvidence("AL", "MK", snapshot.passports.AL.statuses.MK).supportsCurrentStatus).toBe(true);
    for (const [passportCode, destinationCode] of [
      ["AL", "TT"],
      ["LY", "TR"],
    ] as const) {
  ...
  it("covers reviewed Bosnian, Burundian, Congolese and North Macedonian residuals", () => {
    ...
    expect(getVisaRelationshipEvidence("BA", "MK", snapshot.passports.BA.statuses.MK).supportsCurrentStatus).toBe(true);
    for (const [passportCode, destinationCode] of [
      ["MK", "VU"],
    ] as const) {
      expect(
  ...
  it("covers reviewed Israeli, Haitian, Iranian and Sudanese residuals while preserving prohibitions", () => {
    ...
    expect(snapshot.passports.IL.statuses.MV).toBe("entry_restricted");
    expect(getVisaRelationshipEvidence("IL", "MV", "entry_restricted").supportsCurrentStatus).toBe(true);
    for (const [passportCode, destinationCode] of [
      ["IL", "SA"],
    ] as const) {
  ...
  it("closes the reviewed Azerbaijani, South African, Burkinabe, and Bahamian final gaps", () => {
    ...
    for (const passportCode of ["AZ", "BS"] as const) {
      expect(getVisaRelationshipEvidence(passportCode, "MK", snapshot.passports[passportCode].statuses.MK).supportsCurrentStatus)
        .toBe(true);
    }
  });
  ...
  it("closes the reviewed Bhutanese, Colombian, Costa Rican, and Ethiopian final gaps", () => {
    ...
    for (const passportCode of ["BT", "ET"] as const) {
      expect(getVisaRelationshipEvidence(passportCode, "MK", snapshot.passports[passportCode].statuses.MK).supportsCurrentStatus)
        .toBe(true);
    }
    for (const [passportCode, destinationCode] of [
  ...
  it("closes the reviewed Chadian, Zambian, Zimbabwean, and Angolan final gaps", () => {
    ...
    for (const [passportCode, destinationCode, status] of [
      ["TD", "US", "entry_restricted"],
      ["ZM", "US", "entry_restricted"],
      ["ZW", "US", "entry_restricted"],
      ["AO", "US", "entry_restricted"],
    ] as const) {
      expect(getVisaRelationshipEvidence(passportCode, destinationCode, status).supportsCurrentStatus).toBe(true);
      expect(snapshot.passports[passportCode].statuses[destinationCode]).toBe(status);
    }
  ...
  it("closes supportable Korean and Bangladesh pairwise gaps while preserving Iran's scoped holds", () => {
    ...
    for (const destinationCode of [
      "AF", "VG", "BF", "DJ", "GW", "IR", "IQ", "LR", "NE", "KP", "PS", "SY",
    ] as const) {
    ...
    for (const destinationCode of ["SL", "TM"] as const) {
      expect(snapshot.passports.KR.statuses[destinationCode]).toBe("visa_on_arrival");
      expect(getVisaRelationshipEvidence("KR", destinationCode, "visa_on_arrival").supportsCurrentStatus).toBe(true);
    }
  ...
  it("closes Kosovo's Mauritius and Uruguay gaps while preserving low-residual source conflicts", () => {
    ...
    expect(getVisaRelationshipEvidence("SS", "BS", "visa_free").supportsCurrentStatus).toBe(true);
    expect(getVisaRelationshipEvidence("SS", "BA", "visa_required").supportsCurrentStatus).toBe(true);
    for (const destinationCode of ["KY", "BZ", "GT", "NI", "DO"] as const) {
  ...
  it("supports reviewed Czech and Bulgarian routes without guessing Hungarian gaps", () => {
    ...
    expect(snapshot.passports.BG.statuses.SY).toBe("visa_on_arrival");
    expect(getVisaRelationshipEvidence("BG", "SY", "visa_on_arrival").supportsCurrentStatus).toBe(true);
  });
  ...
  it("preserves Bruneian, Liechtenstein and Argentine final route gaps as uncovered", () => {
    expect(getVisaRelationshipEvidence("BN", "MK", snapshot.passports.BN.statuses.MK).supportsCurrentStatus).toBe(true);
    for (const [passportCode, destinationCode] of [
      ["LI", "SL"],
      ["LI", "TT"],
    ] as const) {
  ...
  it("covers reviewed Mexican and Colombian routes while preserving final residual holds", () => {
    ...
    expect(getVisaRelationshipEvidence("MX", "LR", "visa_required").supportsCurrentStatus).toBe(true);
    expect(snapshot.passports.MX.statuses.SL).toBe("visa_on_arrival");
    expect(getVisaRelationshipEvidence("MX", "SL", "visa_on_arrival").supportsCurrentStatus).toBe(true);
  });
  ...
  it("corrects Brazil to Saudi eVisa while preserving Chilean and Peruvian final holds", () => {
    ...
    expect(getVisaRelationshipEvidence("PE", "MK", snapshot.passports.PE.statuses.MK).supportsCurrentStatus).toBe(true);
    for (const [passportCode, destinationCode] of [
      ["CL", "BD"],
      ["CL", "TT"],
      ["PE", "BD"],
  ...
  it("verifies the reviewed home-citizenship cohort without filling the held diagonals", () => {
    const supportedCodes = [
      ...
      "BI", "CF", "EG", "ER", "GA", "GN", "MZ", "BZ", "VE", "CU", "DM", "VC",
    ] as const;
    const heldCodes = [
      "TD", "GQ", "GW", "KP", "PS",
    ] as const;
    ...
    for (const code of supportedCodes) {
      expect(snapshot.passports[code].statuses[code]).toBe("citizenship");
      expect(getVisaRelationshipEvidence(code, code, "citizenship").supportsCurrentStatus).toBe(true);
    }
    for (const code of heldCodes) {
      expect(snapshot.passports[code].statuses[code]).toBe("citizenship");
      expect(getVisaRelationshipEvidence(code, code, "citizenship").supportsCurrentStatus).toBe(false);
    }
  });
  ...
  it("contains only direct HTTPS official-source URLs", () => {
    const officialHosts = new Set([
      "presidence.cd",
      "gabao.mirex.gov.ao",
      "www.conseil-constitutionnel.ci",
      "www.dgsn.cm",
      "lesotholii.org",
      "sgg-mali.ml",
