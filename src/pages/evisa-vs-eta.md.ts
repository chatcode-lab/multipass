...
The mobility score counts destinations accessible without obtaining a visa before departure: visa-free, visa-on-arrival, and ETA destinations. An eVisa remains a visa requiring prior approval, so it appears in detailed access results but does not add to the score. Officially documented entry restrictions are also shown and never add to the score.
