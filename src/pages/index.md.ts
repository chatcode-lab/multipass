...
export const GET: APIRoute = async ({ locals }) => {
  ...
  const body = `${rankingMarkdown(
    ...
    manifest.passports,
  )}\n\n## Passport combination tools and research\n\n- [Improve Passport: measure each added set](${absoluteUrl("/improve")})\n- [Best two- and three-passport combinations](${absoluteUrl("/best-passport-combination")})\n- [Best second passport for US travel access](${absoluteUrl("/best-second-passport-for-us-citizens")})\n- [Exact minimum set for all tracked destinations](${absoluteUrl("/how-many-passports-to-cover-the-world")})\n- [How many passports one person can have](${absoluteUrl("/how-many-passports-can-you-have")})\n- [Dual-citizenship countries and compatibility](${absoluteUrl("/dual-citizenship-countries")})\n- [Citizenship by descent and naturalisation routes](${absoluteUrl("/citizenship-by-descent")})\n\n## Destinations without a separate passport rank\n\n${unranked}\n\n## Regional and language rankings\n\n${collections}`;
